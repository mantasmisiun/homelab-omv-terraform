...
module "pi_stats" {
  ...
  name    = "pi-stats-tf"
  image   = "nginx:1.31.6-alpine@sha256:d10753d9289b8e3f884386351f73554ce72b631378949deddd75e83ee296c427" # 1.31.4-alpine
...
module "ollama" {
  ...
  name    = "ollama"
  image   = "ollama/ollama:0.34.4@sha256:8262851b2846b87c649eddf3e76beb270c52f4d1bc94559f47efde16b0841551"
  restart = "always"
...
module "paperless_postgres" {
  ...
  image   = "docker.io/library/postgres:18.6@sha256:5a5a84b19854a9ffaa54082c166ff4ec27473a361e496e5ea167f298f2da9722"
  restart = "always"
